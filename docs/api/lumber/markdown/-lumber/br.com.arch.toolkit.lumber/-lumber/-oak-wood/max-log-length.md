...
[common]\
open override fun [maxLogLength](max-log-length.md)(maxLogLength: [Int](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-int/index.html)): [Lumber.Oak](../-oak/index.md)
...
| | |
|---|---|
| maxLogLength | The maximum length of the log message for all Oaks. |